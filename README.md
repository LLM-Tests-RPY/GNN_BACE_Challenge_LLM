...
Click here to see the current leaderboard : [Leaderboard](https://hadilaff.github.io/GNN_BACE_Challenge_LLM/leaderboard.html) 
How to Get Started 
...
``` code
git clone https://github.com/hadilaff/GNN_BACE_Challenge_LLM
cd gnn-challenge
```
